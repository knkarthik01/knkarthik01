...
Architect on the **Data Processing Engines** team at AWS - Spark, Iceberg, and the open-source surface of EMR.
 ...
 - 🛠️ **Maintainer** of the official AWS EMR open-source repos ([aws-emr-utilities](https://github.com/aws-samples/aws-emr-utilities), [aws-emr-best-practices](https://github.com/aws/aws-emr-best-practices))  one of fewer than 10 maintainers across 1000s of companies running Amazon EMR.
